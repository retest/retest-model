...
public class PathTest {
	...
	public void string_representation_of_nested_parent_path() throws Exception {
		assertThat( Path.path( Path.path( ELEMENT_0 ), ELEMENT_1 ).toString() ).isEqualTo( "elem[0]/leleme[1]" );
	}
	...
	public void string_representation_of_multilevel_nested_parent_path() throws Exception {
		...
		assertThat( path3.toString() ).isEqualTo( "elem[0]/leleme[1]/bubi/muma[3]" );
		assertThat( Path.fromString( "elem[0]/leleme[1]/bubi/muma[3]" ) ).isEqualTo( path3 );
	}
